#!/usr/bin/env python3
"""
Deploy Parent Category Forms: md25equipmentCategory, md27inputCategory
"""
...
logger = logging.getLogger('deploy_parents')

print("=" * 80)
print("DEPLOYING PARENT CATEGORY FORMS")
print("=" * 80)
print()
...
# Parent forms to deploy
forms = [
    {
        'form_id': 'md25equipCategory',
        'csv_file': 'data/metadata/md25equipCategory.csv',
        'json_file': 'data/metadata_forms/md25equipCategory.json'
    },
    {
        'form_id': 'md27inputCategory',
        'csv_file': 'data/metadata/md27inputCategory.csv',
        'json_file': 'data/metadata_forms/md27inputCategory.json'
    }
]
...
print("=" * 80)
print("COMPLETE DEPLOYMENT STATUS:")
print("=" * 80)
print("Parent forms:")
print("  ✓ md25equipCategory")
print("  ✓ md27inputCategory")
print()
print("Child forms (already deployed):")
print("  ✓ md25equipment (85 items)")
print("  ✓ md27input (40 items)")
print()
print("Now you have cascading dropdowns:")
print("  - Select category → filters equipment/input list")
print("=" * 80)
